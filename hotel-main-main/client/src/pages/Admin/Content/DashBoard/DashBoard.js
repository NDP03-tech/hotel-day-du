    ...
    return (
        <div>
            <div className="d-flex mb-4">
                ...
                <button className="btn btn-primary ml-2" style={{ marginLeft: '30px' }} onClick={handleSearch}>Tìm kiếm</button>
            </div>
                ...
                <table className="table table-bordered table-hover">
                    <thead>
                        ...
                        <tr className="table-dark">
                            ...
                            <th scope="col" className="text-center">Loại Phòng</th>
                            <th scope="col" className="text-center">Doanh Thu (VND)</th>
                    ...
                    <tbody>
                        ...
                        {!_.isEmpty(data) && !isLoading && (
                            <tr className="table-info">
                                <th colSpan="2" className="text-center">Tổng Doanh Thu</th>
