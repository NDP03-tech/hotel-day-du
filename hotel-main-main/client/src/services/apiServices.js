...
export const getReportByMonthYear = (month, year) => {
    return axios.get(`http://localhost:5000/api/report/report/${month}/${year}`);
};
...
export const createReportsModal = (data) => {
    return axios.post(`report/create/${data.month}/${data.year}`,data);
};
export const getReports = (data) => {
    return axios.get('report/create/all');
};
